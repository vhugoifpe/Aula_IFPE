...
#################################################################################################################################################################################
        ...
        if choice == menu[1]:
            ...
            Demandas=st.number_input("Demanda esperada no ano de 2025")
            Demandas.append(st.number_input("Demanda esperada no ano de 2026"))
            Demandas.append(st.number_input("Demanda esperada no ano de 2027"))
            Demandas.append(st.number_input("Demanda esperada no ano de 2028"))
            Demandas.append(st.number_input("Demanda esperada no ano de 2029"))
